...
│   ├── 效率工具（5）         Markdown清理器、PDF合并、风控审合同、OSS供应商评分、写诗
...
| 面试题库（4） | `大厂120.html`、`大厂助手.html`、`大厂面试.html`、`大厂面试笔记.html` | 大厂面试 120 题 |
| 效率工具（5） | `Markdown.html`、`PDF合并.html`、`风控审合同.html`、`供应商2.html`、`写诗.html` | Markdown 清理、PDF 合并、合同风控、OSS 评分、诗词生成 |
