...
知识库整理：从 LLM 技术栈到大模型工程，从计算机科学基础到培养方案，把散落的笔记沉淀成可检索的资料。

| 文件 | 内容 |
|------|------|
| `LLM技术栈.md` | LLM 技术栈学习路线与要点 |
| `大模型全栈工程手册` | 大模型工程化全流程手册 |
| `大模型科学与工程.md` | 大模型原理与工程实践 |
| `计算机科学与技术.md` | 计算机科学基础课程笔记 |
| `算力中心资产管理.pdf` | 算力中心技术与资产管理 |
| `Large Language Model (LLM).pdf` | LLM 参考资料 |
| `贵系培养方案.pdf` / `贵系.docx` | 清华计算机系培养方案与课程 |
| `量化.docx` | 量化交易笔记 |
| `宇宙与物理规律.docx` | 物理规律整理 |
