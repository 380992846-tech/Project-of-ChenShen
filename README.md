...
> 清华大学计算机科学与技术系学生 · 全国中学生物理竞赛省一。仓库四个方向：
...
-  **创意工坊**：清华紫黑风格工具网页作品集、以及《陈深的世界》互动游戏。

>  量化策略为研究/回测用途，**非投资建议**，实盘前需充分验证。
...
**量化/站点**：`量化投资舱.html`、`清华极客量化站.html`、`清华极客创意站.html`、`清华ACM培训站.html`、`大厂面试120题.html`

**生活/展示**：`五道口租房信息站.html`、`英国旅游攻略页.html`、`紫清云笔记工具V4.html`
